                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-9 ">
                                    <div class="text-end">
                                        <button class="btn btn-sm btn-primary btn-icon m-1 " data-repeater-create type="button"><i
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="{{ $logo . '/placeholder.png' }}" width="70px"
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-light-secondary"
                                                                    href="{{ $logo . '/' . $home_logo }}" download="" data-toggle="tooltip"
