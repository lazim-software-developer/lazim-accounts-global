...
class UserController extends Controller
{
    ...
    // Saves currently selected builiding in users table
    public function updateBuildingSelection(Request $request)
    {
        
        $request->validate([
            'building_id' => 'required|exists:mysql_lazim.buildings,id', // Ensure the building ID exists in the buildings table
        ]);

        $user = \Auth::user(); // Get the authenticated user
        $user->building_id = $request->building_id; // Set the new building ID
        $user->save(); // Save the user

        // returning success to reload page on success response
