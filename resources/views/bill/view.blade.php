                                        ...
                                        <table class="table mb-0 table-striped">
                                            ...
                                            @foreach ($items as $key => $item)
                                                @if (!empty($item->product_id))
                                                    <tr>
                                                            ...
                                                            @endphp
                                                                ...
                                                                <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ \Auth::user()->priceFormat($item->tax_amount) }}</td>
                                                                        </tr>
                                                                </table>
                                                                @endif
                                                        </td>
                                                        ...
                                                        <td class="text-end">
                                                            {{ \Auth::user()->priceFormat($item->price * $item->quantity - $item->discount + $item->tax_amount) }}
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                @else
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        {{ \Auth::user()->priceFormat($bill->getAccountTotal()) }}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <tr>
                                                            <td colspan="8"></td>
                                                            <td class="text-end"><b>{{ __('VAT') }}</b></td>
                                                            <td class="text-end">
                                                                {{ \Auth::user()->priceFormat($totalTaxPrice) }}</td>
                                                        </tr>
                                                <tr>
                                                    <td colspan="8"></td>
                                                    <td class="blue-text text-end"><b>{{ __('Total') }}</b></td>
                                                    <td class="blue-text text-end">
                                                        {{ \Auth::user()->priceFormat($bill->total_amount) }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="8"></td>
                                ...
                                <tr>
                                    <td>
                                        @if (!empty($payment->add_receipt))
                                            <a href="{{ env('AWS_URL') . '/' . $payment->add_receipt }}" download=""
                                            ...
                                            <a href="{{ env('AWS_URL') . '/' . $payment->add_receipt }}"
