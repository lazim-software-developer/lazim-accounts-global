        ...
        <div class="row">
            ...
            <div id="invoice-repeater">
                @foreach ($customerDetails as $index => $customerDetail)
                    <div class="repeater-item row" data-item-id="{{ $index }}">

                        {{-- Customer --}}
                        <div class="form-group col-md-6">
                            {{ Form::label("customer_details[$index][customer_id]", __('Customer'), ['class' => 'form-label']) }}
                            <span class="text-danger">*</span> {{-- Required field asterisk --}}
                            {{ Form::select("customer_details[$index][customer_id]", $customers, $customerDetail->customer_id, [
                                'class' => 'form-control select customer-select',
                                'required' => 'required',
                                'id' => "customer_id_$index",
                            ]) }}
                        </div>

                        {{-- Reference Type --}}
                        <div class="form-group col-md-6">
                            {{ Form::label("customer_details[$index][reference_type]", __('Reference Type'), ['class' => 'form-label']) }}
                            <span class="text-danger">*</span> {{-- Required field asterisk --}}
                            {{ Form::select(
                                "customer_details[$index][reference_type]",
                                [
                                ...
                                $customerDetail->reference_type ?? '',
                                [
                                    'class' => 'form-control select reference-type-select',
                                    'required' => 'required',
                                    'id' => "reference_type_$index",
                                ],
                            ) }}
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            {{ Form::label("customer_details[$index][ref_details]", __('Reference Details'), ['class' => 'form-label']) }}
                            <div class="form-icon-user">
                                {{ Form::text("customer_details[$index][ref_details]", $customerDetail->reference_details, [
                                    'class' => 'form-control ref_details',
                                    'id' => "reference_details_$index",
                                ]) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 invoice-field">
                            {{ Form::label("customer_details[$index][invoice_number]", __('Invoice'), ['class' => 'form-label']) }}
                            <span class="text-danger">*</span> {{-- Required field asterisk --}}
                            {{ Form::select("customer_details[$index][invoice_number]", $allInvoices, $customerDetail->invoice_number, [
                        ...
                        {{-- Adjusted Amount --}}
                        <div class="form-group col-md-4">
                            {{ Form::label("customer_details[$index][adjusted_amount]", __('Invoice Amount'), ['class' => 'form-label']) }}
                            <span class="text-danger">*</span> {{-- Required field asterisk --}}
                            <div class="form-icon-user">
                                {{ Form::number("customer_details[$index][adjusted_amount]", $customerDetail->amount, [
                                    'class' => 'form-control adjusted-amount',
                                    'step' => '0.01',
                                    'required' => 'required',
                                    // 'id' => "adjusted_amount_$index",
                                ]) }}
                        ...
                        <div
                            ...
                            <button type="button" class="btn btn-danger remove-repeater-item">
            ...
            <div class="account-repeater">
                @foreach ($bankAllocations as $index => $bankAllocation)
                    <div class="account-repeater-item row" data-item-id="{{ $index }}">

                        {{-- Account --}}
                        <div class="form-group col-md-6">
                            {{ Form::label("bank_details[$index][account_id]", __('Account'), ['class' => 'form-label']) }}
                            <span class="text-danger">*</span> {{-- Required field asterisk --}}
                            {{ Form::select("bank_details[$index][account_id]", $accounts, $bankAllocation->bank_account_id, [
                                'class' => 'form-control select account-select',
                                'required' => 'required',
                        ...
                        {{-- Amount --}}
                        <div class="form-group col-md-6">
                            {{ Form::label("bank_details[$index][amount]", __('Amount'), ['class' => 'form-label']) }}
                            <span class="text-danger">*</span> {{-- Required field asterisk --}}
                            <div class="form-icon-user">
                                {{ Form::number("bank_details[$index][amount]", $bankAllocation->amount, [
            ...
            <div class="form-group col-md-12 clearfix">
                <button type="button" id="add-account-item" class="btn btn-primary">Add Account</button>
                <p id="account-total" class="float-end">Total <span id="account-total-value">0.00</span></p>
            </div>
