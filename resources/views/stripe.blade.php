                            ...
                            <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-4 f-w-600  ">
                                        {{ $admin['currency_symbol'] ? $admin['currency_symbol'] : '$' }}{{ $plan->price . ' / ' . __(\App\Models\Plan::$arrDuration[$plan->duration]) }}</small>
                                        </small>
                                    </h3>
                ...
                <div class="col-xl-9">
                                ...
                                <form role="form" action="{{ route('plan.pay.with.bank') }}" method="post"
                                    ...
                                    <div class="border p-3 rounded banktransfer-payment-div">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <span><b>{{ 'Plan Price : ' }}</b>{{ (!empty($admin['currency_symbol']) ? $admin['currency_symbol'] : '$') . $plan->price }}</span>
                                            </div>

                                            <div class="form-group col-md-6">
                                                <b>{{ 'Net Amount : ' }}</b><span
                                                    class="bank_amount">{{ (!empty($admin['currency_symbol']) ? $admin['currency_symbol'] : '$') . $plan->price }}</span><br>
                    ...
                    @if (isset($admin_payment_setting['is_paiementpro_enabled']) && $admin_payment_setting['is_paiementpro_enabled'] == 'on')
                        <div id="paiementpro_payment" class="card">
                            <div class="card-header">
                                ...
                                <p class="text-sm text-muted">{{__('Details about your plan paiementpro payment')}}</p>
                            </div>
                            <div class="tab-pane " id="paiementpro_payment">
                                <form role="form" action="{{ route('plan.pay.with.paiementpro') }}" method="post" id="paiementpro-payment-form" class="w3-container w3-display-middle w3-card-4">
                                    @csrf
                                            ...
                                            <div class="col-md-12 mt-4 row">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="text-muted apply-coupon" data-toggle="tooltip" data-from="paiementpro" data-title="Apply"><i class="ti ti-square-check btn-apply"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                ...
                                                <button type="submit" data-from="paiementpro" value="{{ __('Pay Now') }}" id="pay_with_paiementpro"
                                                    class="btn btn-xs btn-primary" >{{ __('Pay Now') }}(<span class="paiementpro-final-price">{{ $plan->price }}</span>)</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
                    ...
                    @if (isset($admin_payment_setting['is_nepalste_enabled']) && $admin_payment_setting['is_nepalste_enabled'] == 'on')
                        <div id="nepalste_payment" class="card">
                            ...
                            <div class="tab-pane " id="nepalste_payment">
                                <form role="form" action="{{ route('plan.pay.with.nepalste') }}" method="post" id="nepalste-payment-form" class="w3-container w3-display-middle w3-card-4">
                                    @csrf
                                        <div class="border p-3 rounded ">
                                            <div class="col-md-12 mt-4 row">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="text-muted apply-coupon" data-toggle="tooltip" data-from="nepalste" data-title="Apply"><i class="ti ti-square-check btn-apply"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                ...
                                                <button type="submit" data-from="nepalste" value="{{ __('Pay Now') }}" id="pay_with_nepalste"
                                                    class="btn btn-xs btn-primary" >{{ __('Pay Now') }}(<span class="nepalste-final-price">{{ $plan->price }}</span>)</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
                    ...
                    @if (isset($admin_payment_setting['is_cinetpay_enabled']) && $admin_payment_setting['is_cinetpay_enabled'] == 'on')
                        <div id="cinetpay_payment" class="card">
                            ...
                            <div class="tab-pane " id="cinetpay_payment">
                                <form role="form" action="{{ route('plan.pay.with.cinetpay') }}" method="post" id="cinetpay-payment-form" class="w3-container w3-display-middle w3-card-4">
                                    @csrf
                                        <div class="border p-3 rounded ">
                                            <div class="col-md-12 mt-4 row">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="text-muted apply-coupon" data-toggle="tooltip" data-from="cinetpay" data-title="Apply"><i class="ti ti-square-check btn-apply"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                ...
                                                <button type="submit" data-from="cinetpay" value="{{ __('Pay Now') }}" id="pay_with_cinetpay"
                                                    class="btn btn-xs btn-primary" >{{ __('Pay Now') }}(<span class="cinetpay-final-price">{{ $plan->price }}</span>)</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
                                        ...
                                        <div class="border p-3 rounded ">
                                            <div class="col-md-12 mt-4 row">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="text-muted apply-coupon" data-toggle="tooltip" data-from="fedapay" data-title="Apply"><i class="ti ti-square-check btn-apply"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @if (isset($admin_payment_setting['is_payhere_enabled']) && $admin_payment_setting['is_payhere_enabled'] == 'on')
                        <div id="payhere_payment" class="card">
                            ...
                            <div class="tab-pane " id="paymentwall_payment">
                                <form role="form" action="{{ route('plan.pay.with.payhere') }}" method="post" id="payhere-payment-form" class="w3-container w3-display-middle w3-card-4">
                                    @csrf
                                        <div class="border p-3 rounded ">
                                            <div class="col-md-12 mt-4 row">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="text-muted apply-coupon" data-toggle="tooltip" data-from="payhere" data-title="Apply"><i class="ti ti-square-check btn-apply"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                ...
                                                <button type="submit" data-from="payhere" value="{{ __('Pay Now') }}" id="pay_with_benefit"
                                                    class="btn btn-xs btn-primary" >{{ __('Pay Now') }}(<span class="payhere-final-price">{{ $plan->price }}</span>)</button>
                                            </div>
                                        </div>
                                </form>
                            </div>
