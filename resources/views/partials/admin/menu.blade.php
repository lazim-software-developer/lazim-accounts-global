        ...
        <div class="m-header main-logo">
            <a href="#" class="b-brand">
                <img src="{{ $logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') . '?' . time() }}"
                    alt="{{ config('app.name', 'Lazim-Account') }}" class="logo logo-lg">
            </a>
        </div>
        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                @if (\Auth::user()->type == 'super admin')
                    ...
                    @endcan
                @else
                    @if (false && (Gate::check('manage user') || Gate::check('manage role')))
                        <li
                ...
                @if (Gate::check('manage customer'))
                    <li class="dash-item {{ Request::segment(1) == 'customer' ? 'active' : '' }}">
                        <a href="{{ route('customer.index') }}" class="dash-link ">
                            ...
                            {{-- <span class="dash-mtext">{{ __('Owner') }}</span> --}}
                            <span class="dash-mtext">{{ __('Residents') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note'))
                    <li
                        ...
                        <ul
                            ...
                            @endcan
                            @can('manage bill')
                                <li class="dash-item {{ Request::route()->getName() == 'BillPayment.index' }}">
                                    <a class="dash-link"
                                        href="{{ route('BillPayment.index') }}">{{ __('Bill Payment') }}</a>
                                </li>
                            @endcan
                            @can('manage payment')
                                <li
                ...
                @if (Gate::check('income report') ||
                    ...
                    <li
                        ...
                        <ul
                            ...
                            @endcan
                            <li
                                class="dash-item {{ Request::route()->getName() == 'report.aging' ? ' active' : '' }}">
                                <a class="dash-link"
                                    href="{{ route('report.aging') }}">{{ __('Aging Report') }}</a>
                            </li>
                            {{-- @can('stock report')
                                <li
