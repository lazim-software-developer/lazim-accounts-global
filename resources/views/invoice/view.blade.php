...
@section('content')
            ...
            <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                ...
                <div class="all-button-box mx-2">
                    @if ($invoice->invoice_pdf_link)
                        <a href="{{ route('invoice.pdf.download', $invoice->id) }}" target="_blank"
                            class="btn btn-xs btn-primary btn-icon-only width-auto">
                            <i class="ti ti-download"></i> {{ __('Mollak Invoice Download') }}
                        </a>
                    @else
                        <button class="btn btn-xs btn-primary btn-icon-only width-auto" disabled>
                            {{ __('No Mollak Invoice') }}
                        </button>
                    @endif
                </div>
                <div class="all-button-box mx-2">
    ...
    <div class="row">
                                ...
                                <td>
                                    @if (!empty($revenue->add_receipt))
                                        ...
                                        <a href="{{ $revenuepath . '/' . $revenue->add_receipt }}"
                                            ...
                                            data-bs-toggle="tooltip" title="{{ __('Preview') }}" target="_blank"><span
        ...
        <!-- </div> -->
        <!-- <div class="col-12"> -->
        <h5 class="h4 d-inline-block font-weight-400 mb-2">{{ __('Payment Summary') }}</h5>
        <div class="card">
            <div class="card-body table-border-style">
                <div class="table-responsive">
                    <table class="table ">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (!empty($payment->receipt))
                                        <a href="{{ env('AWS_URL') . '/' . $payment->receipt }}" target="_blank">
                                            <i class="ti ti-file"></i></a>
                                    @elseif(!empty($payment->add_receipt))
                                        <a href="{{ env('AWS_URL') . '/' . $payment->add_receipt }}" target="_blank">
                                            <i class="ti ti-file"></i></a>
                                    @else
                                        --
                                    @endif
