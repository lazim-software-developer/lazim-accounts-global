                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group" id="customer-box">
                                {{ Form::label('customer_id', __('Owner'), ['class' => 'form-label']) }}
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-end">{{ __('Amount') }} <br><small
                                            ...
                                            {{ __('including vat & excluding discount') }}
                                        </small>
                                    </th>
                                    <th></th>
                                </tr>
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0 flex-nowrap">
                                        {{ Form::select('item', $product_services, '', ['class' => 'form-control js-searchBox item', 'data-url' => route('invoice.product'), 'required' => 'required']) }}
                                    </td>
                                    <td>
