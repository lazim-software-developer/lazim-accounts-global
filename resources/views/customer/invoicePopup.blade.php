{{ Form::open(array('route' => array('sync.invoice'),'method'=>'post', 'enctype' => "multipart/form-data", 'onsubmit' => 'handleFormSubmit(event)')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-12 mt-2" style="display: none;">
            ...
            {{ Form::text('customer_id',$id, array('class' => 'form-control','required'=>'required','hidden'=>'true')) }}
        </div>
    </div>
</div>
