@php
    ...
    // $newLangEmailTemp = \App\Models\Utility::newLangEmailTemp('at');
@endphp
...
<head>
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'Lazim Account System') }}
