...
<head>
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'Lazim Account') }}
    ...
    <meta name="author" content=Lazim Accounts />
                ...
                <nav class="navbar navbar-expand-md default">
                    <div class="container-fluid pe-2">
                        <div class="navbar-brand">
                            <a href="#">
                                <img src="https://lazim.s3.me-central-1.amazonaws.com/logo.png"
                                    class="logo" alt="{{ config('app.name', 'Lazim-Account') }}" class="logo logo-lg"
                ...
                <div class="auth-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <span>{{ __('©') }} {{ date('Y') }}
                                    {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Lazim-Account') }}
                                </span>
                            </div>
                        </div>
                    </div>
