...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'retainer', 'class' => 'w-100']) }}
        <div class="col-12">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    <td width="25%" class="form-group pt-0 flex-nowrap">
                                        {{ Form::select('item', $product_services, '', ['class' => 'form-control js-searchBox item', 'data-url' => route('proposal.product'), 'required' => 'required']) }}
                                    </td>
                                    <td>
