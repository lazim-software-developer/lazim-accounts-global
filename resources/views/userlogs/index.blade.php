                                ...
                                @foreach ($logindetails as $logindetail)
                                    ...
                                    @if ($details->status != 'fail')
                                        <tr class="font-style">
                                            ...
                                            <td>
                                                <span
                                                    class="me-5 badge p-2 px-3 rounded bg-success text-capitalize">{{ $logindetail->type }}</span>
                                            </td>
                                            ...
                                            <td class="Action">
                                                <span>
                                                    <div class="action-btn bg-warning ms-2">
                                                        {{-- <a href="{{route('userlogs.show',$logindetail->id)}}" class="mx-3 btn btn-sm align-items-center"   data-bs-toggle="tooltip" data-bs-original-title="{{__('View')}}">
