                                        ...
                                        <div class="btn-box">
                                            ...
                                            <select name="account" class="form-control" required="required">
                                                ...
                                                @foreach ($accounts as $chartAccount)
                                                    <option value="account_{{ $chartAccount['id'] }}" class="subAccount"
                                                        {{ isset($_GET['account']) && 'account_' . $chartAccount['id'] == $_GET['account'] ? 'selected' : '' }}>
                                                ...
                                                @foreach ($vendors as $id => $name)
                                                    <option value="vendor_{{ $id }}" class="subAccount"
                                                        {{ isset($_GET['account']) && 'vendor_' . $id == $_GET['account'] ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach

                                                @foreach ($customers as $id => $name)
                                                    <option value="customer_{{ $id }}" class="subAccount"
                                                        {{ isset($_GET['account']) && 'customer_' . $id == $_GET['account'] ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <tbody>
                                    @php
                                        ...
                                        if (in_array($type, ['customer', 'vendor'])) {
                                            $chartDatas = App\Models\StakeholderTransactionLine::getTransactionHistory(
                                                $type,
                                                $accountId,
                                            );
                                        ...
                                        @foreach ($accounts as $account)
                                            @if ($account->reference == 'Invoice')
                                                <tr>
                                                    ...
                                                    <td>{{ in_array($type, ['customer', 'vendor']) ? $account->user_name : $account->account_name }}
                                                    </td>
                                                    <td>{{ in_array($type, ['customer', 'vendor']) ? $account->account_name : $account->user_name }}
                                                    </td>
                                                    </td>
                                                    ...
                                                    <td>{{ \Auth::user()->priceFormat($account->closing_balance) }}</td>
                                                </tr>
                                            @endif
